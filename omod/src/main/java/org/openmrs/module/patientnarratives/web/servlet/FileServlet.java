...
//        Object videoObject = complexData.getData();
//
////        Integer videoObsId = Integer.parseInt(request.getParameter("videoObsId"));
////
////        Obs complexObs = Context.getObsService().getComplexObs(videoObsId, OpenmrsConstants.RAW_VIEW);
...
////        long length = videoObject.length();
...
//     * @throws IOException If something fails at I/O level.
//     */
//    private static void copy(Object object, OutputStream output, long start, long length)
//            throws IOException
//    {
//
//        byte[] videoObjectData = SerializationUtils.serialize(object);
//        ByteArrayInputStream input = new ByteArrayInputStream(videoObjectData);
//
//        byte[] buffer = new byte[DEFAULT_BUFFER_SIZE];
//        int read;
//
//        if (videoObjectData.length == length) {
//            // Write full range.
